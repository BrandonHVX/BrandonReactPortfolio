    ...
    <Container>
      ...
      <Row>
        ...
        <Col>
          ...
          Summary Driven professional with broad technical understanding of full
          stack web development. . Excellent communicator experienced in
          interpreting and implementing client and staff visions of new
          websites. Known for ability to multitask and juggle multiple pressing
          projects simultaneously meeting all deadlines. Strong background in
      ...
      <Row>
        <Col>
          ...
          Interested in opportunities that will allow me to utilize and enhance
          existing skills. Self motivated individual with potential for career
          advancement.
        </Col>
      </Row>
      <br />
        ...
        <Col xs={12} md={12} lg={6}>
          ...
          <ul className="job-duties">
            <li>
              ...
              check out page that increased user clicks which led to increase of
              service products purchases by 20%.{' '}
            </li>
            <li>
          ...
          <Row>
            <Col>
              {' '}
              <h2 style={styles.position}>Full-Stack Web Developer Program</h2>
